...
const subscription_expiring_cards = `{
...
export { subscription_created, invoice_updated, transaction_successful, transfer_successful, transfer_failed, transfer_reversed,
         invoice_failed, invoice_created, customer_id_success, customer_id_failed, dva_assign_failed, dva_assign_success, payment_request_pending,
  payment_request_success, charge_dispute_create, charge_dispute_remind, charge_dispute_resolve, subscription_disable,
  subscription_not_renew, subscription_expiring_cards,refund_failed, refund_processed, refund_pending, refund_processing
}
